    ...
    <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    <button class="layui-btn layuiadmin-btn-admin" lay-submit lay-filter="LAY-media-search">
        ...
        <div class="layui-card-body">
            ...
            <table id="LAY-media-manage" lay-filter="LAY-media-manage"></table>
...
<script type="text/javascript">
    layui.config({
        ...
        //监听搜索
        form.on('submit(LAY-media-search)', function (data) {
            var field = data.field;

            //执行重载
            table.reload('LAY-media-manage', {
                where: field
            });
        });
